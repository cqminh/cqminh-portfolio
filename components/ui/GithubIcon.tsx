// GitHub's mark isn't shipped by lucide (trademark reasons), so it's drawn
// inline as a plain currentColor path — no dependency on any asset in
// public/, and it inherits whatever color the caller's text/icon context
// sets. Shared by Projects (project card links) and Contact (social row).
